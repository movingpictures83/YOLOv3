...
from plugins.YOLOv3.utils.downloads import gsutil_getsize
from plugins.YOLOv3.utils.metrics import box_iou, fitness
...
def check_file(file, suffix=''):
    ...
    if Path(file).is_file() or file == '':  # exists
        ...
        files = []
        for d in 'data', 'models', 'plugins.YOLOv3.utils':  # search directories
...
def strip_optimizer(f='best.pt', s=''):  # from plugins.YOLOv3.utils.general import *; strip_optimizer()
